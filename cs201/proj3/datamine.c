 ...
 **
 ** This file contains all the functions needed to successfully run proj3
 ** Files included: Datamine.h, and proj3helper.h
 *************************************************************************/
		...
		WEBSITE eduSites[SIZE], WEBSITE govSites[SIZE])
{
  ...
  fprintf(stdout, "EDU sites: (%d Sites)\n", ArrayLength(eduSites));
  for(m = 0; m < ArrayLength(eduSites); m++)
  {
     fprintf(stdout, "     %s\t %d\t%d\t%s.%s.%s\n", eduSites[m].siteType,
	     eduSites[m].hits, eduSites[m].seconds,
	     eduSites[m].webAddress.accessCode, eduSites[m].webAddress.domainName,
  ...
  {
     fprintf(stdout, "     %s\t %d\t%d\t%s.%s.%s\n", comSites[m].siteType,
	     comSites[m].hits, comSites[m].seconds,
	     comSites[m].webAddress.accessCode, comSites[m].webAddress.domainName,
  ...
  {
     fprintf(stdout, "     %s\t %d\t%d\t%s.%s.%s\n", netSites[m].siteType,
	     netSites[m].hits, netSites[m].seconds,
	     netSites[m].webAddress.accessCode, netSites[m].webAddress.domainName,
  ...
  {
     fprintf(stdout, "     %s\t %d\t%d\t%s.%s.%s\n", govSites[m].siteType,
	     govSites[m].hits, govSites[m].seconds,
	     govSites[m].webAddress.accessCode, govSites[m].webAddress.domainName,
